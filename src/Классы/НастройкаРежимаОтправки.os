...
Процедура ПерезаписьИстории(Знач ЗначениеУстановки = Истина) Экспорт
...
Процедура ПрограммнаяОбработкаРезультата(Знач ЗначениеУстановки = Истина) Экспорт
...
Процедура УдалитьВзаимоисключающиеПараметры(МассивПараметров)
	...
	МассивПроверки = МассивМассивВзаимоисключающихПараметров();
...
Функция ПараметрСовместимСRefspec(Знач КлючПараметра)
	...
	МассивПроверки = МассивМассивНесовместимыхПараметровСRefspec();
...
Функция МассивМассивНесовместимыхПараметровСRefspec()
...
Функция МассивМассивВзаимоисключающихПараметров()
