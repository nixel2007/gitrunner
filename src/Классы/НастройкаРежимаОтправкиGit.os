...
// Функция возвращает массив параметров выполения команды git
//
...
// Процедура устанавливает параметры отображения прогресса выполения команды в настройки отправки
// git push --progress
//  Параметры
...
// Процедура устанавливает параметры режима тишины выполения команды в настройки отправки
// git push --quiet
//  Параметры
//     ЗначениеУстановки - булево - По умолчанию Истина 
...
// Процедура устанавливает параметры режима зеркала выполения команды в настройки отправки
// git push --mirror
//  Параметры
//     ЗначениеУстановки - булево - По умолчанию Истина 
...
// Процедура устанавливает параметры режима удаления выполения команды в настройки отправки
// git push --delete
//  Параметры
//     ЗначениеУстановки - булево - По умолчанию Истина 
...
// Процедура устанавливает режим программоной обработки результатов при выполнении команды в настройки отправки
// git push --porcelain
//  Параметры
//     ЗначениеУстановки - булево - По умолчанию Истина 
