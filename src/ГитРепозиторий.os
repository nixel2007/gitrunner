...
Процедура Отправить(Знач ИмяРепозитория = "", Знач ИмяВетки = "", Знач ПерезаписатьИсторию = Ложь) Экспорт
    ...
    Если ПерезаписатьИсторию Тогда
        мНастройкиРежимаОтправки.ПерезаписатьИсторию();
    КонецЕсли;
    
    Если ЗначениеЗаполнено(ИмяРепозитория) Тогда
        мНастройкиРежимаОтправки.УстановитьURLРепозиторияОтправки(ИмяРепозитория);
    КонецЕсли;
    
    Если ЗначениеЗаполнено(ИмяВетки) Тогда
        мНастройкиРежимаОтправки.УстановитьЗаголовкиОтправки(ИмяВетки);
    КонецЕсли;
    
    ПараметрыЗапуска = мНастройкиРежимаОтправки.ПолучитьПараметрыКоманды();
...
Процедура Инициализация()
    ...
    мНастройкиРежимаОтправки = Новый НастройкаРежимаОтправкиGit;
