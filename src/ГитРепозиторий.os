...
Процедура Отправить(Знач ИмяРепозитория = "", Знач ИмяВетки = "", Знач ПерезаписатьИсторию = Ложь) Экспорт
    ...
    Если НастройкаКоманды = Неопределено Тогда
        НастройкаКоманды = Новый НастройкаКомандыPush;
    КонецЕсли;
...
//
// Параметры:
//   НастройкаКомандыPush - НастройкаКомандыPush - инстанс класса НастройкаКомандыPush с необходимыми
//                                                          настройками
//
Процедура УстановитьНастройкуКомандыОтправить(НастройкаКомандыPush) Экспорт
    
	УстановитьНастройкуКоманды("Отправить", НастройкаКомандыPush);
...
Процедура КлонироватьРепозиторий(Знач ПутьУдаленномуРепозиторию, Знач КаталогКлонирования = "") Экспорт
    ...
    Если НастройкаКоманды = Неопределено Тогда
        НастройкаКоманды = Новый НастройкаКомандыClone;
    КонецЕсли;
...
//
// Параметры:
//   НастройкаКомандыClone - НастройкаКомандыClone - инстанс класса НастройкаКомандыClone с необходимыми
//                                                          настройками
//
Процедура УстановитьНастройкуКомандыКлонировать(НастройкаКомандыClone) Экспорт
    
	УстановитьНастройкуКоманды("Клонировать", НастройкаКомандыClone);
...
Функция ЗапуститьИПодождать(Знач Параметры)
    ...
    УстановитьВывод(СокрЛП(РезультатРаботыПроцесса));
...
Процедура Инициализация()
    ...
    ПутьКСкрипту = ОбъединитьПути(ТекущийСценарий().Каталог, "Классы", "КомандаГитРепозитория.os");
	ПодключитьСценарий(ПутьКСкрипту, "КомандаГитРепозитория");
	
    ПутьКСкриптуPush = ОбъединитьПути(ТекущийСценарий().Каталог, "Классы", "НастройкаКомандыPush.os");
	ПодключитьСценарий(ПутьКСкриптуPush, "НастройкаКомандыPush");
	
    ПутьКСкриптуClone = ОбъединитьПути(ТекущийСценарий().Каталог, "Классы", "НастройкаКомандыClone.os");
	ПодключитьСценарий(ПутьКСкриптуClone, "НастройкаКомандыClone");
