...
Процедура ПослеЗапускаСценария(Знач Узел) Экспорт
	ВременныеФайлыМенеджер = БДД.ПолучитьИзКонтекста("ВременныеФайлыМенеджер");
	Если ЗначениеЗаполнено(ВременныеФайлыМенеджер) Тогда
		ВременныеФайлыМенеджер.Удалить();
	КонецЕсли;
КонецПроцедуры
...
Процедура ЯСоздаюВременныйКаталогИСохраняюЕгоВКонтекст() Экспорт
	...
	ВременныеФайлыМенеджер = БДД.ПолучитьИзКонтекста("ВременныеФайлыМенеджер");
	Если НЕ ЗначениеЗаполнено(ВременныеФайлыМенеджер) Тогда
		ВременныеФайлыМенеджер = Новый МенеджерВременныхФайлов();
		БДД.СохранитьВКонтекст("ВременныеФайлыМенеджер", ВременныеФайлыМенеджер);
	КонецЕсли;

	ВременныйКаталог = ВременныеФайлыМенеджер.СоздатьКаталог();
