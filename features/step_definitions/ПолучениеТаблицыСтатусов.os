...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ЯПолучаюМассивФайловКДобавлениюВКоммит");
	ВсеШаги.Добавить("ЯПолучаюМассивФайловВнеИндекса");
	ВсеШаги.Добавить("ЯПолучаюМассивКУдалению");
...
//Я получаю Массив файлов к добавлению в коммит
Процедура ЯПолучаюМассивФайловКДобавлениюВКоммит() Экспорт
	ГитРепозиторий = БДД.ПолучитьИзКонтекста("ГитРепозиторий");
...
Процедура ЯПолучаюМассивКУдалению() Экспорт
	ГитРепозиторий = БДД.ПолучитьИзКонтекста("ГитРепозиторий");
