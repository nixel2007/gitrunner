...
Процедура ПередЗапускомСценария(Знач Узел) Экспорт
	ПутьКСкрипту = ОбъединитьПути(ТекущийКаталог(), "src", "Модули", "РежимУстановкиНастроек.os");
	РежимУстановкиНастроек = ЗагрузитьСценарий(ПутьКСкрипту);
КонецПроцедуры
